  ...
  renderFailureView = () => (
    <div className="job-item-error-view-container">
      <img
        ...
        alt="failure view"
      />
      <h1 className="job-item-failure-text-heading">
        Oops! Something Went Wrong
      </h1>
      <p className="job-item-failure-des">
    ...
    return (
      <div className="job-details-view-container">
        <div className="job-item">
            ...
            <div className="logo-title-container">
              ...
              <div className="title-rating-container">
                ...
                <div className="rating-container">
                  <BsStarFill className="rating-icon" aria-label="close" />
            ...
            <div className="location-package-container">
              <div className="location-employee-container">
                <div className="location-container">
                  <MdLocationOn aria-label="close" className="location-icon" />
          ...
          <div className="life-at-company-des-image-container">
